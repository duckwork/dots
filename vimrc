...
set softtabstop=2                   " number of spaces a <Tab> equals
...
Plug 'ervandew/supertab'                " <Tab> completes everything in Insert
...
if executable('ghc-mod') && has('unix')
    ...
    Plug 'eagletmt/neco-ghc'            " Completion plugin for haskell
endif
if ! has('win32')
...
augroup XMonadDir " {{{
    au!
    au BufRead,BufNewFile ~/.xmonad/* call s:add_xmonad_path()
augroup END
